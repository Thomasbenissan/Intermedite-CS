//I don't knwo what copyrighting my name means so I just put my name at the top of each file
//By Thomas Benissan
...
public class Quiz {
    public static void main(String[] args) throws Exception {
        ...
        String finalAnswer = getAnswer(finalPoints); // set final answer to the sanwer corresponding ot the number of
